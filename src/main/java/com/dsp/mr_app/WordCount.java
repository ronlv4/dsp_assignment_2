...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.addCacheFile(new Path("/stop-words/heb-stopwords.txt").toUri());
        job.getConfiguration().setBoolean("wordcount.skip.patterns", true);
        FileInputFormat.addInputPath(job, new Path("/home/hadoop/input"));
        FileInputFormat.addInputPath(job, new Path(BUCKET_HOME_SCHEME + "input"));
        FileOutputFormat.setOutputPath(job, new Path("/home/hadoop/outputs/output" + System.currentTimeMillis()));
        FileOutputFormat.setOutputPath(job, new Path(BUCKET_HOME_SCHEME + "outputs/output" + System.currentTimeMillis()));
